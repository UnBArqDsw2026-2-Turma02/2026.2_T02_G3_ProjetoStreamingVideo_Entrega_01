...
<p id="ref14"><strong>[14]</strong> GRUPO DE TRABALHO. <em>Sem título 1.docx</em>. Eliminação de Gargalos de Fonte Única.</p>

<p id="ref15"><strong>[15]</strong> PEERTUBE. <em>Architecture: Concepts</em>. PeerTube Documentation.</p>

<p id="ref16"><strong>[16]</strong> GRUPO DE TRABALHO. <em>Sem título 1.docx</em>. Análise de Ingestão e Processamento RTMP.</p>

<p id="ref17"><strong>[17]</strong> GRUPO DE TRABALHO. <em>Sem título 1.docx</em>. Componentes do Cliente e P2P Media Loader.</p>

<p id="ref18"><strong>[18]</strong> FASTIO. <em>Adaptive Bitrate Streaming Explained - ABR Guide 2026</em>.</p>

<p id="ref19"><strong>[19]</strong> UC SANTA BARBARA. <em>The Streaming Control Loop: Buffering, DASH, ABR | CS 176C</em>.</p>

<p id="ref20"><strong>[20]</strong> WIKIPÉDIA. <em>Transmissão dinâmica adaptável por HTTP. Independência de Codecs e QoE</em>.</p>

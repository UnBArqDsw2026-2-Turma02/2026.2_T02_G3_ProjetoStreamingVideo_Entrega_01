...
<font size="3"><p style="text-align: center">Fonte: Autoria de [Gabriel Diniz](https://github.com/GabrielDiniz12), [Breno Teixeira](https://github.com/brenolteixeira) e  [Pedro Americo](https://github.com/dev-americo).</p></font>
...
<font size="3"><p style="text-align: justify">Figura 6: Teste em Navegador.</p></font>

![Teste](../../../assets/teste_sub1C.png)

<font size="3"><p style="text-align: justify">Fonte: Autoria de [Pedro Americo](https://github.com/dev-americo).</p></font>
...
<p id="ref15"><strong>[15]</strong> WIKIPÉDIA. <em>Transmissão dinâmica adaptável por HTTP. Independência de Codecs e QoE</em>. <strong>Trecho utilizado:</strong> Conceitos de MPEG-DASH (Dynamic Adaptive Streaming over HTTP) e a adaptabilidade dinâmica da transmissão de mídia. Disponível em: <a href="https://pt.wikipedia.org/wiki/Dynamic_Adaptive_Streaming_over_HTTP">https://pt.wikipedia.org/wiki/Dynamic_Adaptive_Streaming_over_HTTP</a>.</p>

<p id="ref16"><strong>[16]</strong> PEERTUBE. <em>PeerTube Architecture Blueprint</em>. <strong>Trecho utilizado:</strong> Detalhes da interação técnica entre o cliente web em Angular, as rotas Express do backend, o rastreador WebTorrent Tracker e o motor de transcodificação de vídeo FFmpeg. Disponível em: <a href="https://docs.joinpeertube.org/contribute/architecture">https://docs.joinpeertube.org/contribute/architecture</a>.</p>

<p id="ref17"><strong>[17]</strong> PEERTUBE. <em>Especificação do Protocolo de Redundância do PeerTube</em>. <strong>Trecho utilizado:</strong> Mecanismos de funcionamento de WebSeeds para encapsulamento de fatias de mídia (.ts) e o processo de sincronização de cache federado via protocolo ActivityPub. Disponível em: <a href="https://docs.joinpeertube.org/contribute/architecture#redundancy-between-instances">https://docs.joinpeertube.org/contribute/architecture#redundancy-between-instances</a>.</p>

<p id="ref18"><strong>[18]</strong> SERRANO, Milene. <em>Estilos e Padrões Arquiteturais II (Slides de Aula)</em>. <strong>Trecho utilizado:</strong> Fundamentação teórica e análise comparativa contendo as características, vantagens, desvantagens e topologias dos modelos estruturais Cliente-Servidor e Peer-to-Peer. Disponível em: <a href="https://aprender3.unb.br/">https://aprender3.unb.br/</a>.</p>

<p id="ref19"><strong>[19]</strong> GOOGLE. <em>Google Global Cache (GGC) Operator Documentation</em>. <strong>Trecho utilizado:</strong> Especificações de infraestrutura física de cache de borda e topologia de distribuição de conteúdo através de nós de CDN localizados em provedores de internet parceiros. Disponível em: <a href="https://isp.google.com/ggc/">https://isp.google.com/ggc/</a>.</p>

<p id="ref20"><strong>[20]</strong> YOUTUBE. <em>YouTube Live Streaming API Reference</em>. <strong>Trecho utilizado:</strong> Documentação de endpoints REST públicos para a administração, segurança, monitoramento e controle de chaves de transmissões centralizadas ao vivo. Disponível em: <a href="https://developers.google.com/youtube/v3/live/">https://developers.google.com/youtube/v3/live/</a>.</p>

<p id="ref21"><strong>[21]</strong> W3C. <em>Media Source Extensions (MSE) Specification</em>. <strong>Trecho utilizado:</strong> Definição do padrão de API JavaScript para permitir o carregamento e bufferização adaptativa de segmentos binários de mídia diretamente no player web HTML5 do navegador. Disponível em: <a href="https://www.w3.org/TR/media-source/">https://www.w3.org/TR/media-source/</a>.</p>
...
| 3.5 | [Pedro Americo](https://github.com/dev-americo) | Correção de Referências | 28/08/2026 |
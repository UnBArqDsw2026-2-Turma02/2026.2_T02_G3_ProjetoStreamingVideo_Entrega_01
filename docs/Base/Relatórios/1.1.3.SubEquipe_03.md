...
Fizemos uma reunião [24-08](/docs/Atas/SubEquipe_03/24-08-26.md)
...
Considerando as orientações para desenvolvimento disponibilizadas no site da [disciplina](https://sites.google.com/view/unb-fcte-arqdsw/m%C3%B3dulos/m%C3%B3dulo-base?authuser=0), a elaboração do *Rich Picture* tornou-se mais clara e intuitiva. Além disso, o uso das ilustrações vetorizadas encontradas no site [Storyset](https://storyset.com/) contribuiu para a representação dos elementos do sistema, facilitando a compreensão e a organização das informações.

...
A pesquisa feita para a elaboração desse foco foi feita colaborativamente, com discussões feitas em reuniões e no WhatsApp da equipe. A elaboração dos diagramas também foi feita principalmente pelo José Augusto, e depois foi revisada e corrigido pelo Pedro Lucas, 

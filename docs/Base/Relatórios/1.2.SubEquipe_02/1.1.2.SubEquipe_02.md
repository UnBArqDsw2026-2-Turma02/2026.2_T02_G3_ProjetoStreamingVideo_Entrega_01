...
|---|---|---|
| FOCO_01 — Artefatos Generalistas & NFR Framework | Rich Picture e SIGs de Usabilidade, Performance e Segurança. | [Rich Picture](/Base/Relatórios/1.2.SubEquipe_02/richpicture.md) e [NFR Framework](/Base/Relatórios/1.2.SubEquipe_02/nfrframework.md). |
| FOCO_02 — Engenharia Reversa & Modelagem BPMN | Análise do frontend do PeerTube em quatro perspectivas e modelagem do cenário de pesquisa e reprodução de vídeo. | [Engenharia Reversa](/Base/Relatórios/1.2.SubEquipe_02/Engenharia_reversa.md) e [Modelagem BPMN](/Base/Relatórios/1.2.SubEquipe_02/modelagem_bpmn.md). |
| FOCO_03 — IA Generativa | Registro individual de lições aprendidas e avaliação crítica do uso de IA. | [Lições Aprendidas e IA Generativa](/Base/Relatórios/1.2.SubEquipe_02/IA_generativa.md). |
...
A fundamentação, a gravação e o histórico estão reunidos na [documentação do Rich Picture](/Base/Relatórios/1.2.SubEquipe_02/richpicture.md).
...
Também estão disponíveis as versões com marcações de avaliação de <a href="./assets/NFR%20-%20Usabilidadecheck%20.drawio.png" target="_blank" rel="noopener">Usabilidade</a>, <a href="./assets/Performance_NFR%20%281%29.jpg" target="_blank" rel="noopener">Performance</a> e <a href="./assets/NFR_seguran%C3%A7a.drawio.png" target="_blank" rel="noopener">Segurança</a>.
...
A descrição dos elementos, as referências e a evolução dos três SIGs estão na [documentação do NFR Framework](/Base/Relatórios/1.2.SubEquipe_02/nfrframework.md).
...
As capturas, os dez fluxos, os elementos arquiteturais e os critérios avaliados estão na [documentação de Engenharia Reversa](/Base/Relatórios/1.2.SubEquipe_02/Engenharia_reversa.md).
...
<a href="./assets/BPMN.jpg" target="_blank" rel="noopener">Abrir o diagrama em tamanho original</a>.
...
A explicação dos elementos, as decisões e a divisão da modelagem estão na [documentação BPMN](/Base/Relatórios/1.2.SubEquipe_02/modelagem_bpmn.md).
...
|[Paulo Vitor Gomes](https://github.com/gpaulovit) | Pude fazer um estudo aprofundado sobre como esses artefatos ajudam na construção efetiva de uma aplicação útil e escalável, além de ter assumido uma frente na qual não tenho tanta familiaridade, que é o frontend, onde pude entender melhor as abordagens e os frameworks usados nas soluções, além de entender o papel de cada artefato na solução. Além disso, fiz pela primeira vez um processo mais aprofundado de engenharia reversa. | A IA generativa me ajudou principalmente no processo de análise estática de código, devido ao tamanho do repositório observado, e a entender melhor os materiais e conteúdos abordados. Eu a utilizava também para possíveis verificações do conteúdo criado por mim, em ferramentas que usavam os materiais da disciplina como base. Além disso, ela ajudou a delegar tarefas e a estabelecer um certo padrão nos meus processos de engenharia reversa.                 |              
...
*Tabela de reflexões individuais. [Lições Aprendidas e IA Generativa](/Base/Relatórios/1.2.SubEquipe_02/IA_generativa.md).*
